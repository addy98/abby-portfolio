...
function Footer() {
    return (
        <footer name='bg-theme-toggle' className='bg-black footer'>
            <Container>
                <Row>
                    <Col sm={{span: 10, offset: 1}}>
                        ...
                        <div className='flex flex-justify-between'>
                            ...
                            <div name='text-theme-toggle' className='inter-small text-white'>Developed by <a className='addison' target="_blank" rel="noreferrer" href="https://www.linkedin.com/in/addison-west/">Addison West</a></div>
                        </div>
                    </Col>
                </Row>
            </Container>
